  ...
  return (
    <ScrollView>
      <View style={styles.view}>
        ...
        <Link href={{ pathname: "/dogs" }}>
          <Text>Go to dogs Page</Text>
        </Link>
        <TextInput placeholder="hello everyone"></TextInput>
        <Text>{orientationName}</Text>
        <Text>{orientation}</Text>
        <ThemeText>
          Lorem ipsum dolor sit amet, consectetur adipiscing elit. Hamlet, sed
          do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim
          ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut
          aliquip ex ea commodo consequat. Romeo and Juliet. Duis aute irure
          dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat
          nulla pariatur. Excepteur sint occaecat cupidatat non proident, sunt
          in culpa qui officia deserunt mollit anim id est laborum. Macbeth.
        </ThemeText>
